function gotoUserReview() {
  window.setTimeout(
    function() {
        ...
        document.getElementById('comments_tabs').classList.remove('in', 'active');
        ...
        document.getElementById('comments_tabs_label').classList.remove('active');
...
function gotoUserComment() {
    window.setTimeout(
        function() {
            document.getElementById('product_tabs_description').classList.remove('in', 'active');
            document.getElementById('reviews_tabs').classList.remove('in', 'active');
            document.getElementById('comments_tabs').classList.add('in', 'active');
            document.getElementById('description_tabs_label').classList.remove('active');
            document.getElementById('reviews_tabs_label').classList.remove('active');
